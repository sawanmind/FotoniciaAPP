...
//        label.font = UIFont(name: "Stag Sans", size: 15)
//        
//        
//        var newFrameForImage: CGRect = (self.frame)
//        newFrameForImage.size.height = self.frame.height*0.4
//        newFrameForImage.size.width = self.frame.height*0.4
...
//        let widthConstraint = NSLayoutConstraint(item: img, attribute: NSLayoutAttribute.width, relatedBy: NSLayoutRelation.equal, toItem: self.contentView, attribute: NSLayoutAttribute.height, multiplier: 0.3, constant: 0)
//        let heightConstraint = NSLayoutConstraint(item: img, attribute: NSLayoutAttribute.height, relatedBy: NSLayoutRelation.equal, toItem: self.contentView, attribute: NSLayoutAttribute.height, multiplier: 0.3, constant: 0)
//        
//        //Visual Constraints
