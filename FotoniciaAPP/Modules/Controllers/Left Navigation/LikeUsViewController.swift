...
class LikeUsViewController: UIViewController , UIWebViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.navigationItem.title = "LIKE US"
...
//        self.showLeftBarButtonItemWithImage()
        ...
        if let url = URL(string: "https://www.facebook.com/fotonicia/") {
